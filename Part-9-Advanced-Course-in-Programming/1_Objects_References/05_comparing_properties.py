...
class RealProperty:
    ...
    def price_difference(self, compared_to: "RealProperty"):
        first_total_price = self.square_metres*self.price_per_sqm
        second_total_price = compared_to.square_metres*compared_to.price_per_sqm
        return abs(first_total_price - second_total_price)
    
    def more_expensive(self, compared_to: "RealProperty"):
        first_total_price = self.square_metres*self.price_per_sqm
        second_total_price = compared_to.square_metres*compared_to.price_per_sqm
        return first_total_price > second_total_price
